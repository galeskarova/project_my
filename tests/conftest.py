...
def card_test_data(request: pytest.FixtureRequest) -> Tuple[Union[str, int], str]:
    return cast(Tuple[Union[str, int], str], request.param)
...
def account_test_data(request: pytest.FixtureRequest) -> Tuple[Union[str, int], str]:
    return cast(Tuple[Union[str, int], str], request.param)
